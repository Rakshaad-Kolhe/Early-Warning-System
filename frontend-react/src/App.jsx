...
export default function App() {
  ...
  const emergingThreats = [
    { name:'Novel respiratory cluster',    firstSeen:'2026-02-18', symptoms:'fever, dry cough, fatigue',         confidence:'78%' },
    { name:'Acute gastroenteritis signal', firstSeen:'2026-02-20', symptoms:'vomiting, diarrhea, dehydration',   confidence:'64%' },
    { name:'Febrile rash outbreak',        firstSeen:'2026-02-22', symptoms:'rash, joint pain, low-grade fever', confidence:'71%' },
  ];
